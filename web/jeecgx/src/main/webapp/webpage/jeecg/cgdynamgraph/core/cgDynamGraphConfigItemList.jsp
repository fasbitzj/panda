		...
		<c:if test="${fn:length(cgDynamGraphConfigItemList)  > 0 }">
			<c:forEach items="${cgDynamGraphConfigItemList}" var="poVal" varStatus="stuts">
				<tr>
					...
					<td align="left"><input name="cgDynamGraphConfigItemList[${stuts.index }].dictCode" maxlength="500" type="text" class="inputxt" style="width: 120px;" value="${poVal.dictCode }"></td>
