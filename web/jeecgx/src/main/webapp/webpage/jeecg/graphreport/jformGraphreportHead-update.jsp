  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="jformGraphreportHeadController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td align="right">
				<label class="Validform_label">1x轴数据:</label>
			</td>
			<td class="value">
				...
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">1x轴数据</label>
			</td>
			<td align="right">
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect field="dbSource" dictTable="t_s_data_source" dictField="DB_KEY" dictText="DB_KEY" defaultVal="${jformGraphreportHeadPage.dbSource}"/><span class="Validform_checktip"></span>
			</td>
		</tr>
