...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="cgreportConfigHeadController.do?doUpdate">
	...
	<!-- 		update-begin--Author:huangzq  Date:20151129 for：[753]【在线报表】扩展增加俩字段，非必填-------------------- -->
		<tr>
			...
			<td class="value"><input id="returnTxtField" name="returnTxtField" type="text" style="width: 150px" class="inputxt" value="${cgreportConfigHeadPage.returnTxtField}"> <span class="Validform_checktip"></span></td>
...
<table style="display: none">
	<tbody id="add_cgreportConfigItem_table_template">
		<tr>
			...
			<td align="left"><input name="cgreportConfigItemList[#index#].dictCode" maxlength="1000" type="text" class="inputxt" style="width: 120px;"></td>
