...
public class MockX509CRL extends X509CRL {
    ...
    /**
     * @see X509CRL#getRevokedCertificates()
     */
    @Override
    ...
    /**
     * @see X509CRL#verify(PublicKey, String)
     */
    @Override
